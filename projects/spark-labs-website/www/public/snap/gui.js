...
//     pname = this.scene.name || localize('');
...
//     this.toggleRawOpenProjectStringAppMode(true);
...
// IDE_Morph.prototype.toggleRawOpenProjectStringAppMode = function (appMode) {
...
//         null, // target - not needed here
//         action, // a toggle function
//         this.object.name || localize(''), // label string
//         query, // predicate/selector
//         null, // environment
//         null // hint
//     );
...
//     var menu, str,
//         ide = this.parentThatIsA(IDE_Morph),
//         name = this.object.name || localize('');
