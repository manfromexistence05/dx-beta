...
//   // Methods with any return type and arguments
//   someMethod(arg1: any, arg2?: any): any;
//   anotherMethod(): any;
...
const DockIcon = ({
  ...
  return (
    <motion.div
      ...
      style={{ width }}
      className={cn(
        "flex aspect-square cursor-pointer items-center justify-center w-full rounded-md hover:bg-primary hover:text-primary-foreground",
        className,
      )}
      {...props}
    >
...
function Page({ params }: { params: { slug: string } }) {
  ...
  const [submissionIdentication, setSubmissionIdentication] = useState<any>([]);
  useEffect(() => {
    ...
    submissions.map((items: any) => items.id === params.slug && setSubmissionIdentication(items))
  ...
  useEffect(() => {
    if (worldRef.current) {
      ...
      let submittedProject = submissions.find((submission: any) => submission.id === params.slug);
      let matchedSubmittedProject = `<project name="Untitled" app="Snap! 9.0, https://snap.berkeley.edu" version="2"><notes></notes><thumbnail>data:image/png;base64,</thumbnail><scenes select="1"><scene name="Untitled"><notes></notes><hidden></hidden><headers></headers><code></code><blocks></blocks><stage name="Stage" width="480" height="360" costume="0" color="255,255,255,1" tempo="60" threadsafe="false" penlog="false" volume="100" pan="0" lines="round" ternary="false" hyperops="true" codify="false" inheritance="true" sublistIDs="false" id="5"><pentrails>data:image/png;base64,</pentrails><costumes><list struct="atomic" id="6"></list></costumes><sounds><list struct="atomic" id="7"></list></sounds><variables></variables><blocks></blocks><scripts></scripts><sprites select="8"><sprite name="Sprite" idx="1" x="42.97877056362586" y="-32.9787705636258" heading="180" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="80,80,80,1" pen="tip" id="12"><costumes><list struct="atomic" id="13"></list></costumes><sounds><list struct="atomic" id="14"></list></sounds><blocks></blocks><variables></variables><scripts><script x="38" y="34"><block s="forward"><l>10</l></block><block s="turn"><l>15</l></block></script></scripts></sprite><sprite name="Sprite(2)" idx="2" x="6" y="-156" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="119.64599999999997,175.95,0,1" pen="tip" id="22"><costumes><list struct="atomic" id="23"></list></costumes><sounds><list struct="atomic" id="24"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite><sprite name="Sprite(3)" idx="3" x="209" y="90" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="181.04999999999998,0,162.94500000000005,1" pen="tip" id="28"><costumes><list struct="atomic" id="29"></list></costumes><sounds><list struct="atomic" id="30"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite><sprite name="Sprite(4)" idx="4" x="135" y="-117" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="188.7,124.542,0,1" pen="tip" id="34"><costumes><list struct="atomic" id="35"></list></costumes><sounds><list struct="atomic" id="36"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite><sprite name="Sprite(5)" idx="5" x="81" y="42" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="95.625,0,191.25,1" pen="tip" id="40"><costumes><list struct="atomic" id="41"></list></costumes><sounds><list struct="atomic" id="42"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite><sprite name="Sprite(6)" idx="6" x="-115" y="-114" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="86.7,0,62.423999999999985,1" pen="tip" id="46"><costumes><list struct="atomic" id="47"></list></costumes><sounds><list struct="atomic" id="48"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite><sprite name="Sprite(7)" idx="7" x="149" y="142" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="36.71999999999987,0,183.6,1" pen="tip" id="52"><costumes><list struct="atomic" id="53"></list></costumes><sounds><list struct="atomic" id="54"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite><sprite name="Sprite(8)" idx="8" x="54" y="90" heading="90" scale="1" volume="100" pan="0" rotation="1" draggable="true" costume="0" color="0,34.68000000000003,86.7,1" pen="tip" id="58"><costumes><list struct="atomic" id="59"></list></costumes><sounds><list struct="atomic" id="60"></list></sounds><blocks></blocks><variables></variables><scripts></scripts></sprite></sprites></stage><variables></variables></scene></scenes></project>`;

      const ideInstance: any = new IDE_Morph({
        // load: submittedProject.xml,
        noExitWarning: true,
        mode: "presentation",
        design: "flat",
      });
  ...
  // submissions.find((submission: any) => submission.id === params.slug && ide.loadProjectXML(submission.xml));
  ...
  return (
    <>
      ...
      <Link href="/dashboard" className="flex-center fixed top-0 left-0 w-[152.25px] h-[28.25px] z-50">
        <img className="h-12 w-auto" src="/logo.png" alt="logo" />
      </Link>

      <div className='fixed top-[28px] left-0 w-full h-[2px] z-50 bg-border'></div>
      {/* {runProject && <div className="flex-center fixed top-0 left-0 h-full w-full rounded-md border bg-background z-10">
        {submissions.map((submission: any) => submission.id === params.slug && <Button ref={divRef} onClick={() => {
          ide.loadProjectXML(submission.xml);
          setRunProject(!runProject);
        }} key={submission.id}>Loading {submission.title} Project...</Button>)}
      </div>} */}
      ...
      >
        <ResizablePanel defaultSize={25} className='max-w-[30%] min-w-[350px]'>
          <div className="flex h-full flex-col gap-5">
            <div className='w-full border-b flex items-start justify-start p-3'>
              <Link href="/dashboard" className="flex-center bg-background w-[152.25px] h-[29.25px]">
                <img className="h-16" src="/logo.png" alt="logo" />
              </Link>
            </div>
            <div className='flex items-start justify-center h-full w-full px-3'>
              <div className='border rounded-md p-3 w-full'>
                <span className='font-mono text-start w-full font-bold text-md'>Project Details</span>
                {submissions.map((items: any) => items.id === params.slug && <>
                  <div className="flex items-center justify-start gap-2 py-1.5 hover:bg-primary-foreground">
                    <p className="flex flex-row text-center">Student: </p>
                    {users.map((user: any) => user.id === items.userId && <span key={user.id} className="w-auto select-all text-start">{user.username.toUpperCase()}</span>)}
                  </div>
                  <div className="flex items-center justify-start gap-2 py-1.5 hover:bg-primary-foreground">
                    <p className="flex flex-row text-center">Title: </p>
                    <span className="w-auto select-all text-start">{items.title || "No Title is Provided."}</span>
                  </div>
                  <Separator />
                  <div className="flex items-center justify-start gap-2 py-1.5 hover:bg-primary-foreground">
                    <p className="flex flex-row text-center">Description: </p>
                    <span className="w-auto select-all text-start">{items.description || "No Description is Provided."}</span>
                  </div>
                  <Separator />
                  <div className="flex items-center justify-start gap-2 py-1.5 hover:bg-primary-foreground">
                    <p className="flex flex-row text-center">Time: </p>
                    <span className="w-auto select-all text-start">{items.time || "No Time is Provided."}</span>
                  </div>
                  <Separator />
                  <div className="flex items-center justify-start gap-2 py-1.5 hover:bg-primary-foreground">
                    <p className="flex flex-row text-center">Classroom: </p>
                    {classrooms.map((classroom: any) => classroom.id === items.classroomId && <span className="w-auto select-all text-start">{classroom.title || "No classroom title found"}</span>)}
                  </div>
                </>)}
              </div>
            </div>
      ...
      <canvas className="h-full" ref={worldRef}></canvas>

      {/* <div className="flex h-full flex-col gap-5 fixed top-0 left-0 w-[360px] bg-background border-r">
        <div className='w-full border-b flex items-center justify-center p-1 border-b'>
          <Link href="/dashboard" className="flex items-start justify-start w-full">
            <img className="h-16" src="/logo.png" alt="logo" />
          </Link>
        </div>
        <div className='flex items-start justify-center h-full w-full px-3'>
      ...
      <div className={cn("min-h-max w-[450px] rounded-md fixed bottom-12 left-[calc(50%-225px)] transform items-end bg-background hidden ", submitBar ? "scale-in-ver-bottom" : "slide-out-blurred-top")}>
        ...
        <div className='flex items-start justify-center h-full w-full w-full mb-10'>
          <div className='border rounded-md p-3 w-full'>
            <span className='font-mono text-start w-full font-bold text-md'>Project Details</span>
            {submissions.map((items: any) => items.id === params.slug && <div key={items.id}>
              <div className="flex items-center justify-start gap-2 py-1.5 hover:bg-primary-foreground">
                <p className="flex flex-row text-center">Student: </p>
                {users.map((user: any) => user.id === items.userId && <span key={user.id} className="w-auto select-all text-start">{user.username.toUpperCase()}</span>)}
              </div>
      ...
      <div onClick={() => {
        setSubmitBar(!submitBar);
      }} className='w-[450px] bg-background p-3 rounded-md border text-center hover:bg-primary-foreground hover:text-primary fixed bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>{submitBar ? "Close" : "View"} Details</div>
